...
- Add support for Bedrock Rerank API [#9029](https://github.com/opensearch-project/documentation-website/pull/9029)
...
These updates provide comprehensive documentation for new features, improvements, and changes introduced in OpenSearch 2.19.0. For more detailed information on each update, please refer to the linked pull requests.